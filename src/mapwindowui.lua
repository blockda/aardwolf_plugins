...
exitsLabel = luajava.new(TextView,context)
--exitsLabel:setTextSize(22)
exitsLabel:setTextAppearance(context,TextAppearanceSmall)
exitsLabel:setText("BELOW THE MAP")
exitsLabel:setTextColor(ColorCompat:argb(255,15,200,15))
exitsLabel:setGravity(Gravity.CENTER)
exitsLabel:setId(6022)
--holder:addView(label)

titleLabel = luajava.new(TextView,context)
--titleLabel:setTextSize(25)
titleLabel:setTextAppearance(context,TextAppearanceMedium)
titleLabel:setText("ABOVE THE MAP")
titleLabel:setTextColor(ColorCompat:argb(255,15,200,15))
